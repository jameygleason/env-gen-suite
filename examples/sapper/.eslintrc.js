...
module.exports = {
  ...
  plugins: ["svelte3", "node", "import", "json"],
  overrides: [
    {
      files: ["**/*.svelte"],
  ...
  rules: {
    ...
    "import/no-unresolved": [
      2,
      {
        ignore: [
          "@sapper",
          "@signalchain/utils/isEmpty",
          "@signalchain/utils/mapToObject",
          "@signalchain/utils/mkdir",
          "@signalchain/utils/printElapsed",
          "@signalchain/utils/printObject",
          "@signalchain/utils/rimraf",
          "@signalchain/utils/safeJSONParse",
          "@signalchain/utils/slugify",
          "@signalchain/utils/toUpperCase",
          "@signalchain/utils/unsafeStripHTML",
          "@signalchain/utils/wait",
        ],
      },
    ],
    ...
    "no-unused-vars": [
      "error",
      {
        ...
        varsIgnorePattern: "^_|req|res|next|args|ctx|__|errors",
      },
    ],
